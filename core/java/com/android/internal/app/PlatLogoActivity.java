...
public class PlatLogoActivity extends Activity {
    ...
    private View makeView() {
        ...
        String xeVersion = SystemProperties.get("ro.modversion");
        ...
        tv.setText(mIsXe ? "XenonHD" : "Android " + Build.VERSION.RELEASE);
        view.addView(tv, lp);
        ...
        tv.setTextColor(0xFFFFFFFF);
        tv.setShadowLayer(4*metrics.density, 0, 2*metrics.density, 0x66000000);
        tv.setText(mIsXe ? "Android " + Build.VERSION.RELEASE : "JELLY BEAN");
        view.addView(tv, lp);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final boolean isXe = getIntent().hasExtra("is_xe");
        mIsXe = isXe;
        ...
        mContent.setImageResource(isXe ? com.android.internal.R.drawable.xelogo
        ...
        mContent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mToast.show();
                mContent.setImageResource(isXe ? com.android.internal.R.drawable.xelogo_alt
